    ...
    <div className="about">
      ...
      <div>
        ...
        <p>
          ...
          <h3>{listIcon} Creating lightweight processes that work for teams</h3>{" "}
          I like to show my work and the work of my team. I enjoy finding tools
          and easy processes that allow teams to work faster and more joyfully.
          I am allergic to copying and pasting.
        </p>
        <h2>{listIcon} Education</h2>
        <p>
          {" "}
          <h3>{listIcon} 2009 – 2013</h3>
          Khenchela University (Algeria) Bachelor of Science: agricultural
          science
          <br></br>
          ...
          addition to my constant desire to learn more, my study at this
          institute opened new horizons for discovery and other studies before
          me even after Study period ends
        </p>
      </div>
    </div>
  );
